    ...
    C: crate::con::XcbConnection,
{
    fn use_extension(
        ...
        let major_opcode = self.major_opcode(crate::proto::xkb::EXTENSION_NAME).ok_or(
            crate::error::Error::MissingExtension(crate::proto::xkb::EXTENSION_NAME),
        )?;
